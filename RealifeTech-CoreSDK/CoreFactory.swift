...
public enum CoreFactory {
    ...
    /// This MUST be called before any other SDK functionality is acessed.
    /// - Parameters
    ///  apiHelper: V3APITokenManagable generated by makeApiHelper
    ///  completion: Optional closure with default nil value
    public static func requestValidToken(fromApiHelper apiHelper: V3APITokenManagable, completion: (() -> Void)? = nil) {
